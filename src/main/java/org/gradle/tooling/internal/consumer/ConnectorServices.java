...
public class ConnectorServices {
    ...
    private static class ConnectorServiceRegistry implements ServiceRegistrationProvider {
      ...
      /*  @Provides
        ...
        @Provides
        protected ConnectionFactory createConnectionFactory(//ToolingImplementationLoader toolingImplementationLoader, 
        ExecutorFactory executorFactory, LoggingProvider loggingProvider) {
            return new ConnectionFactory(//toolingImplementationLoader,
             executorFactory, loggingProvider);
        }
    }
}
