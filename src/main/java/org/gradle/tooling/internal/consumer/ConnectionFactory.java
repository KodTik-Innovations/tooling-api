...
public class ConnectionFactory {
   // private final ToolingImplementationLoader toolingImplementationLoader;
    ...
    public ProjectConnection create(//Distribution distribution,
     ConnectionParameters parameters, ProjectConnectionCloseListener listener) {
        ConsumerActionExecutor lazyConnection = new LazyConsumerActionExecutor(// distribution, toolingImplementationLoader,
         loggingProvider, parameters);
